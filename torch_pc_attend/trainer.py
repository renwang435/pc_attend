...
class Trainer(object):
    ...
    def __init__(self, config, data_loader):
        ...
        self.model_name = 'ram_{}_{}_{}'.format(
            config.num_samples, config.num_points, config.glimpse_scale
        )
        ...
        self.model = RecurrentAttention(
            self.num_points, self.num_samples, self.box_size, self.glimpse_scale,
    ...
    def reset(self):
        ...
        l_t = torch.Tensor(self.batch_size, 3).uniform_(-1, 1)
