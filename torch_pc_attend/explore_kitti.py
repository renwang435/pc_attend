...
from parseKITTI_XML import parseXML as xmlParser


ret = xmlParser('kitti_data/2011_09_26/2011_09_26_drive_0001_sync/tracklet_labels.xml')

for trackletObj in ret:
...
velo_range = range(0, third_velo.shape[0], 1000)
