...
glimpse_arg.add_argument('--num_points_per_sample', type=int, default=100,
                         help='Number of points in each sample of a point cloud')
glimpse_arg.add_argument('--box_size', type=float, default=0.6,
                         help='Initial size of box to sample points from')
glimpse_arg.add_argument('--glimpse_scale', type=int, default=2,
                         help='scale of successive patches')
glimpse_arg.add_argument('--num_samples', type=int, default=1,
                         help='# of scaled boxes to sample points from')
...
reinforce_arg.add_argument('--std', type=float, default=0.22,
...
data_arg.add_argument('--num_points_per_pc', type=int, default=10000,
                         help='Number of points each point cloud')
...
misc_arg.add_argument('--modelnet_dir', type=str, default='modelnet40_normal_resampled',
                      help='Directory to original ModelNet40 files')
misc_arg.add_argument('--partition_dict', type=str, default='./partition_dict.txt',
                      help='Location of partition dictionary')
misc_arg.add_argument('--labels_dict', type=str, default='./labels_dict.txt',
                      help='Location of label dictionary')
