class Params(object):
    win_size = 8                                #Glimpse window size
    ...
    sensor_size = bandwidth * depth             #Total size of sensor
    ...
    loc_dim = 3                                 #Dimension of location (2D MNIST images)
    num_glimpses = 6                            #Number of glimpses allowed
    num_classes = 40                            #Number of classes for classification task (10 digits for MNIST)
    ...
    # Testing parameter setting for filter-based stochastic sampling
